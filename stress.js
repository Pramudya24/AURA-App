class StressAnalyzer {
  ...
  // Generate insight kesehatan mental
  generateInsight() {
    const avg = this.rataRata7Hari();
    if (!avg) return "Belum ada data scan. Lakukan scan pertama kamu!";

    if (avg.avgHRV > 50)
      return "HRV kamu bagus! Tubuh dalam kondisi rileks dan pulih dengan baik.";
    if (avg.avgHRV > 30)
      return "Stres sedang terdeteksi. Coba luangkan waktu 10 menit meditasi hari ini.";
